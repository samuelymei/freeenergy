...
\begin{figure}[htbp]
	...
	\addplot[color=green,mark=none,samples=500,domain=-13:10] {-10*ln(exp(-0.1*(x+5)*(x+5))+exp(-0.1*(10+2*(x-5)*(x-5))))};
    ...
    \node[color=green] at (axis cs: 1.2,25.5) {\footnotesize$s=s_1$};
