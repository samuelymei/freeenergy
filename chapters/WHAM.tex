...
Let us assume that the total normalized unbiased probability distribution $\rho_{0}(\eta)$ can be obtained by a linear $\eta$-dependent combination of the unbiased probability distribution $\rho_{i}^{(u)}(\eta)$ 
\begin{equation}
