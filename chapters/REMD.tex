...
\begin{center}
	\schemestart \chemfig{A} + \chemfig{B} \arrow{<=>} \chemfig{C} \schemestop
\end{center}
%\[
...
\begin{center}
	\schemestart \chemfig{P_{A}} + \chemfig{H^{+}} \arrow{<=>} \chemfig{P_{A}H^{+}} \schemestop
\end{center}
%\[
...
written as
\begin{center}
	\schemestart \chemfig{A} + \chemfig{H^{+}} \arrow{<=>} \chemfig{AH^{+}} \schemestop
\end{center}
%\[
