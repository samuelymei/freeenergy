...
Recent improvement over the ordinary metadynamics on convergence issue can be found in Ref.~\cite{BarducciPRL2008}, which is termed well-tempered metadynamics.
