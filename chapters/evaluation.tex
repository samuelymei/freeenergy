...
\begin{align}
    B(M)=&\left<\Delta A(M)\right>-\Delta A\notag\\
        =&-\beta^{-1}\ln{\left[\frac{1}{M}\left(e^{-\beta W^\ast}+(M-1)\times \frac{\int_{W^\ast}^{\infty}\diff We^{-\beta W}p_A(W)}{1-C_A(W^\ast)}\right)\right]}-
        \Delta A\notag\\
        =&-\beta^{-1}\ln{\left[\frac{1}{M}\left(e^{-\beta W^\ast_{dis}}+(M-1)\times \frac{1-C_B(W^\ast)}{1-C_A(W^\ast)}\right)\right]},
...
\begin{equation}
    B(M)=-\beta^{-1}\int_{-\infty}^\infty\diff W^\ast P_A^\ast(W^\ast)\ln{\left[\frac{1}{M}\left(e^{-\beta W^\ast_{dis}}+(M-1)\times \frac{1-C_B(W^\ast)}{1-C_A(W^\ast)}\right)\right]}.
\end{equation}
